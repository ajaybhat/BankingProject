...
public class ViewFrame extends JFrame {
	...
	void viewFrame(int toggle, final int accno, final int permission,
		...
		if (toggle == 1) {
			...
			int columncount = 5;
			String columns[] = { "Account No", "Transaction Date",
			...
			int columncount = 8;
			String columns[] = { "Account No", "Name", "Address", "Phone No",
